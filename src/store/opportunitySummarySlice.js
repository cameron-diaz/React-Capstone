...
export const opportunitySummarySlice = createSlice({
...
export const { setOpportunitySummary } = opportunitySummarySlice.actions;
export default opportunitySummarySlice.reducer;
